...
namespace Ryujinx.HLE.HOS.Services.Nv.NvDrvServices.NvHostCtrl
{
    internal class NvHostCtrlDeviceFile : NvDeviceFile
    {
        ...
        private static readonly bool IosEventWaitPromotionEnabled =
            string.Equals(Environment.GetEnvironmentVariable("MELONX_IOS_EVENTWAIT_PROMOTION"), "1", StringComparison.Ordinal);
        ...
        private NvInternalResult EventWait(ref NvFence fence, ref uint value, int timeout, bool isWaitEventAsyncCmd, bool isWaitEventCmd)
        {
            ...
            if (OperatingSystem.IsIOS() && IosEventWaitPromotionEnabled)
            {
